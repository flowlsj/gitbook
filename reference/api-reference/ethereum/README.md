...
* [eth\_getBalance](broken-reference)
* [eth\_getCode](broken-reference)
* [eth\_getTransactionCount](broken-reference)
* [eth\_getStorageAt](broken-reference)
* [eth\_call](broken-reference)
...
On this page we provide examples of how to use individual JSON\_RPC API endpoints using the command line tool, [curl](https://curl.se). These individual endpoint examples are found below in the [Curl examples](broken-reference) section. Further down the page, we also provide an [end-to-end example](broken-reference) for compiling and deploying a smart contract using a Geth node, the JSON\_RPC API and curl.
...
* [eth\_blockNumber](broken-reference)
* [eth\_sendRawTransaction](broken-reference)
...
* [eth\_getCode](broken-reference)
* [eth\_call](broken-reference)
* [eth\_estimateGas](broken-reference)
...
* [eth\_getBlockTransactionCountByHash](broken-reference)
* [eth\_getBlockTransactionCountByNumber](broken-reference)
* [eth\_getUncleCountByBlockHash](broken-reference)
* [eth\_getUncleCountByBlockNumber](broken-reference)
* [eth\_getBlockByHash](broken-reference)
* [eth\_getBlockByNumber](broken-reference)
* [eth\_getTransactionByHash](broken-reference)
* [eth\_getTransactionByBlockHashAndIndex](broken-reference)
* [eth\_getTransactionByBlockNumberAndIndex](broken-reference)
* [eth\_getTransactionReceipt](broken-reference)
* [eth\_getUncleByBlockHashAndIndex](broken-reference)
* [eth\_getUncleByBlockNumberAndIndex](broken-reference)
...
#### net\_listening <a href="#net_peercount" id="net_peercount"></a>
...
#### net\_peerCount <a href="#net_listening" id="net_listening"></a>
...
Signs a transaction that can be submitted to the network at a later time using with [eth\_sendRawTransaction](broken-reference).
...
See [eth\_call](broken-reference) parameters, expect that all properties are optional. If no gas limit is specified geth uses the block gas limit from the pending block as an upper bound. As a result the returned estimate might not be enough to executed the call/transaction when the amount of gas is higher than the pending block gas limit.
...
**Returns** See [eth\_getBlockByHash](broken-reference)
...
Result see [eth\_getBlockByHash](broken-reference)
...
**Returns** See [eth\_getTransactionByHash](broken-reference)
...
Result see [eth\_getTransactionByHash](broken-reference)
...
Creates a filter object, based on filter options, to notify when the state changes (logs). To check if the state has changed, call [eth\_getFilterChanges](broken-reference).
...
Creates a filter in the node, to notify when a new block arrives. To check if the state has changed, call [eth\_getFilterChanges](broken-reference).
...
Creates a filter in the node, to notify when new pending transactions arrive. To check if the state has changed, call [eth\_getFilterChanges](broken-reference).
...
Uninstalls a filter with given id. Should always be called when watch is no longer needed. Additionally Filters timeout when they aren't requested with [eth\_getFilterChanges](broken-reference) for a period of time.
...
**Returns** See [eth\_getFilterChanges](broken-reference)
...
Result see [eth\_getFilterChanges](broken-reference)
...
#### shh\_newIdentity (deprecated){#shh\_newidentity}
...
#### shh\_hasIdentity (deprecated){#shh\_hasidentity}
...
#### shh\_newGroup (deprecated){#shh\_newgroup}
...
#### shh\_addToGroup (deprecated){#shh\_addtogroup}
...
#### shh\_newFilter (deprecated){#shh\_newfilter}
...
#### shh\_uninstallFilter (deprecated){#shh\_uninstallfilter}

Uninstalls a filter with given id. Should always be called when watch is no longer needed. Additionally Filters timeout when they aren't requested with [shh\_getFilterChanges](broken-reference) for a period of time. **Note** this function is deprecated.
...
#### shh\_getFilterChanges (deprecated){#shh\_getfilterchanges}

Polling method for whisper filters. Returns new messages since the last call of this method. **Note** calling the [shh\_getMessages](broken-reference) method, will reset the buffer for this method, so that you won't receive duplicate messages. **Note** this function is deprecated.
...
**Returns** See [shh\_getFilterChanges](broken-reference)
...
Result see [shh\_getFilterChanges](broken-reference)
